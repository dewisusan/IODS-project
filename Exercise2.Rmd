...
learning2014 <- select(one_of(learning2014, keep_columns))
...
p1 <- ggplot(learning2014, aes(col = gender, x = attitude, y = points))
...
summary(my_model, data = learning2014)
...
# print out a summary of the model
summary(my_model2, data = learning2014)
...
summary(new_data, data = learning2014)

# Predict the new students exam points based on attitude
predict(m, new_data = newdata )
