...
g1 <- ggplot(alc, aes(col = sex, x = high_use, y = G3))

# define the plot as a boxplot and draw it
g1 + geom_boxplot() + ylab("grade")

# initialize a plot of high_use and absences
g2 <- ggplot(alc, aes(col = sex, x = absences, y = G3))
...
coef(high_use ~ failures + sex, data = alc, family = "binomial")
...
g <- geom_point(aes(x = probabilities, y = high_use, col = prediction))
...
prop.table(addmargins(., high_use = alc$high_use, prediction = alc$prediction))
```
