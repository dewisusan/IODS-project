...
cor_matrix <- round (Boston, digits = 2)
...
boston_scaled <- as.data.frame(class)
...
dist_eu <- dist(Boston, method = "euclidean", diag = FALSE, upper = FALSE, p = 2)

# look at the summary of the distances
summary(dist_eu)

# manhattan distance matrix
dist_man <- dist(Boston, method = "manhattan", diag = FALSE, upper = FALSE, p = 2)
